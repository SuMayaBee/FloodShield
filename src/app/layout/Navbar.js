...
<div className="flex-[4%] flex bg-slate-800 text-white text-sm p-3 shadow-lg text-center">
  <div className="items-center self-center font-bold text-lg tracking-wide">
    FloodShield
  </div>
</div>
